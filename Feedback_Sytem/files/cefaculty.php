...
<html lang="en">
    ...
    if (isset($_POST['b2']))
    {
      ...
      if (!$dbhandler)
        ...
        $password = $_POST['fpwd'];
        $result = mysqli_query($dbhandler, "select * from faculty where fusername='$username' and fpassword='$password'");
        ...
        <div class="limiter">
            ...
            <div class="container-login100" style="background-image: url('images/p1.jpeg');">
                ...
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    ...
                    <form action="faculty.php" method="POST" class="login100-form validate-form">
                        <span class="login100-form-title p-b-49">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Password is required">
                            ...
                            <input class="input100" type="password" name="fpwd" placeholder="Type your password">
                            <span class="focus-input100" data-symbol="&#xf190;"></span>
                        </div>
                        <br>
                        
                        <center>
                            <font size="4" color="red">Invalid Captch??</font>
                        ...
                        <div class="container-login100-form-btn">
                            <div class="wrap-login100-form-btn">
                                ...
                                <button type="submit" name="b2" class="login100-form-btn">
                                    Login
                                </button>
                            </div>
                        </div>
