  ...
  border: 2px solid ;
    ...
    <body background="p1.jpeg">
        ...
        if (isset($_POST['b1'])) {
            ...
            $sql1="SELECT * FROM faculty where fusername='vnd'";
            ...
            if($b1==0 && $b2==0 && $b3==0 && $b4==0 && $b5==0 && $b6==0 )
            {
             ...
             $sql = "UPDATE faculty SET teaching_skill='$a1',knowledge='$a2',communication_skill='$a3',"
                    ...
                    . "other_activity='$a6' WHERE fusername='vnd'";
            }
            else
            {
               $a1=($a1+$b1)/2;
                    ...
                    <th colspan="2"><h1 style="color:white;">
                                ...
                                <h1></th>
                                    ...
                                    <tr><td colspan="2" align="center">
                                                ...
                                                <a href="f3.php" class="button button5" ><font size="4">Next</font></a></td></tr>
