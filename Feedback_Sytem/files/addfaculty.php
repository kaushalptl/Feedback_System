    ...
    <body>
       ...
       if(isset($_POST['b1']))
       {
                ...
                if ($conn->connect_error) {
                 ...
                 $pwd=$_POST['fpwd'];
                $sql = "INSERT INTO faculty (fname,lname,fusername,fpassword)
        ...
        <div class="limiter">
            ...
            <div class="container-login100" style="background-image: url('images/p1.jpeg');">
                ...
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    ...
                    <form action="addfaculty.php" method="POST" class="login100-form validate-form">
                        ...
                        <br>
                         <span class="login100-form-title p-b-49">
                            <a href="admin1.php"><font size="6">Back</font></a>
