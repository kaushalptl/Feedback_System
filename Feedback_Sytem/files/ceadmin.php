...
<html lang="en">
    ...
    <body>
        <?php
        session_start();
        if(isset($_POST['ausername'])&& isset($_POST['apwd']))
        {
        if ($_POST['ausername'] == "kaushal" && $_POST['apwd'] == "kaushal")
            {
                ...
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    ...
                    <form action="admin.php" method="POST" class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
                            ...
                            <input class="input100" type="text" name="ausername" placeholder="Type your username">
                            <span class="focus-input100" data-symbol="&#xf206;"></span>
                        </div>

                        <div class="wrap-input100 validate-input" data-validate="Password is required">
                            <span class="label-input100">Password</span>
                            <input class="input100" type="password" name="apwd" placeholder="Type your password">
                            <span class="focus-input100" data-symbol="&#xf190;"></span>
                        </div>
                        <br>
                         <center>
