  ...
  border: 2px solid ;
    ...
    <body background="p1.jpeg">
        ...
        if (isset($_POST['b1'])) {
            ...
            $sql1="SELECT * FROM feedback where username='smm123'";
            ...
            if($b1==0 && $b2==0 && $b3==0 && $b4==0 && $b5==0 && $b6==0 )
            {
             ...
             $sql = "UPDATE feedback SET teaching_skill='$a1',knowledge='$a2',communication_skill='$a3',"
                    . "integrate_with_other_courses='$a4',intrest_generate_by_teacher='$a5',"
                    . "other_activity='$a6' WHERE username='smm123'";
            }
            else
            {
               $a1=($a1+$b1)/2;
                    ...
                    <th colspan="2"><h1 style="color:white;">
                                ...
                                <h1></th>
                                    ...
                                    <tr><td>
                                        ...
                                        <td>
                                            <input type="radio" name="f1" value="f11"  >5
                                    ...
                                    <tr><td>
                                        ...
                                        <td>
                                            <input type="radio" name="f2" value="f21" >5
                                    ...
                                    <tr><td>
                                            ...
                                            <input type="radio" name="f3" value="f31" >5
                                    ...
                                    <tr><td>
                                            ...
                                            <input type="radio" name="f4" value="f41" >5
                                    ...
                                    <tr><td>
                                            ...
                                            <input type="radio" name="f5" value="f51" >5
                                    ...
                                    <tr><td>
                                            ...
                                            <input type="radio" name="f6" value="f61" >5
                                    ...
                                    <tr><td colspan="2" align="center">
                                                ...
                                                <a href="f4.php" class="button button5" ><font size="4">Next</font></a></td></tr>
